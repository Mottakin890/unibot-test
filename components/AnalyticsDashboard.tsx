...
import { Workspace, ChatMessage, MessageRole } from '../src/types';
            ...
            <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
                <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[80vh] animate-fade-in-up">
                    <div className="px-6 py-4 border-b bg-slate-50 flex justify-between items-center">
                        ...
                        <button onClick={() => setSelectedSessionId(null)} className="text-slate-400 hover:text-slate-600">&times;</button>
                    </div>
